...
CREATE TABLE `viewed` (
  `id` int NOT NULL,
  `filmId` int NOT NULL,
  `co_viewer` varchar(200) DEFAULT NULL,
  `date` date NOT NULL,
  `notes` varchar(45) DEFAULT NULL,
  `rating` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `viewedFilm_idx` (`filmId`),
  KEY `viewedRating_idx` (`rating`),
  CONSTRAINT `viewedFilm` FOREIGN KEY (`filmId`) REFERENCES `films` (`id`),
  CONSTRAINT `viewedRating` FOREIGN KEY (`rating`) REFERENCES `rating` (`id`)
